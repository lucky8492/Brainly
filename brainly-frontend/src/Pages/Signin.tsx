   ...
   try{
    ...
    return <div className="h-screen w-screen flex justify-center items-center bg-gray-200">
            <div className="bg-white rounded-xl border border-slate-200 min-w-80 p-2 ">
                ...
                <Button text="Signin" isLoading={false} fullWidth={true} onClick={signin} size="md" variant="Primary" />
                </div>
                <div onClick={()=>{navigate("/signup")}} className="p-4 text-blue-600 underline hover:cursor-pointer">
                   Create Account
                </div>
            </div>
